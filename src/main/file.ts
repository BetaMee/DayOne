...
async function startFileDataBaseServer() {
  // const dbpath = path.resolve(`~/Library/Mobile\ Documents/com\~apple\~CloudDocs/DayOne`)
...
// const path = '~/Library/Mobile\ Documents/com\~apple\~CloudDocs/DayOne/test.json'
...
export default startFileDataBaseServer
